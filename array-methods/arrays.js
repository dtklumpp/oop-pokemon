...
let adults = ages.filter(gamu => gamu >= 18);
console.log(adults);
console.log(ages.every(taco => taco>=18));
console.log(adults.every(taco => taco>=18));
...
//filter only british
let britons = tagMap.filter(taco => taco.Language === "en");
//how many just british
console.log(britons.length);

//print names of french tags
/*
tagMap.forEach(taco => {
    if(taco.Language === "fr"){
        console.log(taco.TagName);
    }
})
*/

//check no TagID = 0
console.log(tagMap.every(taco => taco.TagID != 0));

//any with tagid 46/
console.log(tagMap.some(taco => taco.TagID ===46));
//any with 45
console.log(tagMap.some(taco => taco.TagID ===45));

//map to TagName (language)
